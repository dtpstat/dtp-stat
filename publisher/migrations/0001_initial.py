# Generated by Django 3.1.14 on 2025-08-27 00:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('consumer_key', django_cryptography.fields.encrypt(models.CharField(max_length=255))),
                ('consumer_secret', django_cryptography.fields.encrypt(models.CharField(max_length=255))),
                ('access_token', django_cryptography.fields.encrypt(models.CharField(max_length=255))),
                ('access_token_secret', django_cryptography.fields.encrypt(models.CharField(max_length=255))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', django_cryptography.fields.encrypt(models.CharField(max_length=20))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('schedured', 'Запланирован'), ('success', 'Успех'), ('caughtError', 'Ошибка'), ('uncaughtError', 'Катастрофа')], max_length=13, null=True, verbose_name='Статус')),
