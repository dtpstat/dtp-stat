# Generated by Django 3.0.4 on 2020-06-21 10:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, db_index=True, default=None, help_text='name', max_length=1000, null=True)),
                ('is_filter', models.BooleanField(db_index=True, default=False)),
                ('code', models.CharField(blank=True, default=None, help_text='code', max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
